...
if __name__ == '__main__':
    ...
    backend_name = FLAGS.model.split("_")[1]
    ...
    if FLAGS.mode == 'image':
        ...
        inputs_reg = []
        outputs_reg = []
        inputs_reg.append(grpcclient.InferInput("images", [8, 3, 64, 64], "FP32"))
        outputs_reg.append(grpcclient.InferRequestedOutput("output"))
        ...
        send_images = get_text_from_img(input_image, detected_objects)
        print(send_images.shape)
        
        # print(np.argmax(result_char, axis=1))
